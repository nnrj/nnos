...
#define FILE_NAME_SIZE 8    // 文件基本名长度
#define FILE_EXTEN_SIZE 3   // 文件扩展名长度
#define FILE_FULL_NAME_SIZE FILE_NAME_SIZE + FILE_EXTEN_SIZE // 文件全名长度（文件基本名长度 + 文件扩展名长度）
...
static unsigned char table_rgb[COLORNUM * 3] = {
    // 静态无符号的16×3的颜色表格二维数组（节省空间，亦可加快绘制速度）。static char 只能用于数据
...
/*开机动画点阵*/
/* static char LOGO_GRAPH[16][50] = { //使用50*16点阵画出鼠标指针，点阵数据存在二维数组中
    "00000000000000000000000000000001000000000000000000",
    "01110000011100000011111100000010100000001000001000",
    "01001000010010000010000000000010100000001000010000",
    "01000100010001000010000000000100010000001000100000",
    "01000100010000100010000000000100010000001001000000",
    "01001000010000100010000000001000001000001010000000",
    "01110000010000000010000000001000001000001100000000",
    "01100000011110000011111110001000001000001100000000",
    "01010000010100000010000000001111111000001010000000",
    "01001000010010000010000000010000000100001001000000",
    "01000100010001000010000000010000000100001000100000",
    "01000010010000100010000000010000000100001000010000",
    "01000010010000100010000000100000000010001000001000",
    "01000010010000100010000000100000000010001000001000",
    "01111100010000110011111100100000000010001000001100",
...
/* static char LOGO_GRAPH[16][50] = { //使用50*16点阵画出鼠标指针，点阵数据存在二维数组中
    ...
    "011100000111000000111111000000101000000100000100",
    "010010000100100000100000000000101000000100001000",
    "010001000100010000100000000001000100000100010000",
    "010001000100001000100000000001000100000100100000",
    "010010000100001000100000000010000010000101000000",
    "011100000100000000100000000010000010000110000000",
    "011000000111100000111111100010000010000110000000",
    "010100000101000000100000000011111110000101000000",
    "010010000100100000100000000100000001000100100000",
    "010001000100010000100000000100000001000100010000",
    "010000100100001000100000000100000001000100001000",
    "010000100100001000100000001000000000100100000100",
    "010000100100001000100000001000000000100100000100",
    "011111000100001100111111001000000000100100000110",
    "000000000000000000000000000000000000000000000000",
    "000000000000000000000000000000000000000000000000",
    "000000000000000000000000000000000000000000000000",
    "000000000000000000000000000000000000000000000000",
